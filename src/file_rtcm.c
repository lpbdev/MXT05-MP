...
//    opt->sys = 4;    /* GPS+QZS+BDS+GAL+GLO 0001 1111*/
...
//    double dr[3], rr[3], enu[3];
//
//    char infile[6][MAXSTRPATH], fileDir[MAXSTRPATH];
//    char optsys[] = "Tmp_SingleBDS", lsqOrkalman[] = "lsq";
//
...
//    char infileDir[MAXSTRPATH] = "F:\\data\\BDS\\ShuiKu2\\";
//
//    if (argc == 2)
...
//
//    pos1[0] = 23.213132794 * D2R;
//    pos1[1] = 113.8309659831666667 * D2R;
//    pos1[2] = 4.667;
//
//    pos2[0] = 23.213384352333333 * D2R;
//    pos2[1] = 113.8310317661666667 * D2R;
//    pos2[2] = 4.99866;
//
//    rr[0] = -2611692.7396;
//    rr[1] = 4751725.6154;
...
//
//    double bsl = 11000;
//    double tt1 = bsl / 1000.0;
//    double tes1, tes2;
//    if (bsl < 1000) {
//        tes1 = 0.0025;
//    }
//    else {
//        tes2 = 0.0025 + bsl / 1000.0 * 0.0005;
//    }
//
//    pos2ecef(pos1, rr);
//    //pos2ecef(pos2, rb);
//    for (i = 0; i < 3; i++) dr[i] = rr[i] - rb[i];
//
//    ecef2enu(pos1, dr, enu); //大地坐标转站心坐标
//
//    double test2 = 0.003 + 0.003 * pow(10, 0.1 / 0.5);
//    double test = 0.003 + 0.003 * pow(10, 0.5 / 0.5); //+ (a0 + a1 * exp(-el * R2D / 20.0));
//
//
//    m = 0; n = 0;
//
...
//    svr.rtk.opt.smoothWindowsTime = 12;
...
//
// // svr.rtk.rb[0] = svr.rtk.opt.rb[0] = -2286280.2800;
//    //svr.rtk.rb[1] = svr.rtk.opt.rb[1] = 5003466.8492;
//    //svr.rtk.rb[2] = svr.rtk.opt.rb[2] = 3217157.2630;
//
//
//    strinitcom();//初始化网络
...
//        mkdir(outDir);
//
//    sprintf(filepath, "%s%c%s_%s_%s.log", outDir, sep, optsys, "debug", lsqOrkalman);
//    oFile.fpDebug = fopen(filepath, "w");
//    sprintf(filepath, "%s%c%s_%s_%s.pos", outDir, sep, optsys, "rtk", lsqOrkalman);
//    oFile.fpOut[0] = fopen(filepath, "w");
//    sprintf(filepath, "%s%c%s_%s_%s.pos", outDir, sep, optsys, "filter", lsqOrkalman);
//    oFile.fpOut[1] = fopen(filepath, "w");
//
...
//        if (strstr(file->d_name, "rover") && strstr(file->d_name, "txt")) {
//            sprintf(strpath[0], "%s%c%s", fileDir, sep, file->d_name);
//        }
//        if (strstr(file->d_name, "base") && strstr(file->d_name, "txt")) {
